        ...
        return (
            <div className="Sidebar-container">
                ...
                <form>
                  ...
                  <div className="radio">
                    <label>
                      <input type="radio" value='circuitous' checked={this.props.circuit} onChange={() => {this.props.handleOptionChange(true)}} />
                      Round-trip
                    </label>
                  </div>
                  <div className="radio">
                    <label>
                      <input type="radio" value='linear' checked={!(this.props.circuit)} onChange={() => {this.props.handleOptionChange(false)}} />
                      One-way
                    </label>
                  </div>
                </form>
